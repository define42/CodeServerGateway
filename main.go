...
func login(w http.ResponseWriter, req *http.Request) {
	...
	if ldapok {
		...
		fmt.Fprintf(w, "<br><br><table class=\"table table-borderless mx-auto w-auto\">")
		fmt.Fprintf(w, "<tr><th><font color=\"#0065A9\">Visual Studio Code Gateway</font></th></tr>\r\n")
		fmt.Fprintf(w, "<tr><td><img src=/proxypublic/logo.jpg height=180></td></tr>")
